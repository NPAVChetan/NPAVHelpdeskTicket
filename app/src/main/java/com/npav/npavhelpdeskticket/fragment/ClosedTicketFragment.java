...
ClosedTicketFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_closed_ticket, container, false);
    ...
    private void callGetTicketAPI(Tickets obj) {
        ...
        String url = "https://www.support.test.netprotector.net/api/ticket/web/list/closed/" + start + "/" + end;
